...
function Abrir_Cofre () {
    ...
    if (ultima_direccion == "arriba" && personaje.tileKindAt(TileDirection.Top, assets.tile`cofre_abajo`)) {
        tiles.setTileAt(tiles.getTileLocation(columna, fila - 1), assets.tile`cofre_arriba`)
        cofre_abierto = true
        ...
        tiles.setTileAt(tiles.getTileLocation(columna - 1, fila), assets.tile`cofre_arriba`)
        cofre_abierto = true
